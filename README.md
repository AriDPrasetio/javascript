...
- [x] Apa itu JavaScript, cara menjalankan JavaScript
...
- [ ] Exception handling (try/catch/finally, throw, Error Objects)
...
- [ ] `this` di method, function, alone, event handler, arrow function
...
- [ ] Debugging issues (breakpoints, console methods)
- [ ] Debugging performance dasar
